...
public class TextFileEditor {
    ...
    void setFontDefault() {
	text.setFont(new Font(shell.getDisplay(), PreferenceConverter.getFontData(PreferenceManager.getDefaultPreferenceStore(), PreferenceManager.SETTINGS_FONT_VIEWER)));
    }
	...
	if (fontData != null) {
	    ...
	    text.setFont(font);
	    PreferenceConverter.setValue(PreferenceManager.getDefaultPreferenceStore(), PreferenceManager.SETTINGS_FONT_VIEWER, fontData);
	}
    }
