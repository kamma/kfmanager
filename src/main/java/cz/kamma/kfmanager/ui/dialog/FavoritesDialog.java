...
public class FavoritesDialog extends Dialog {
	...
	mButtonMoveDown.setEnabled(mTableWidget.getSelectionIndex() > -1 && mTableWidget.getSelectionIndex() < mTableWidget.getItemCount() - 1);
    }
	...
	if (reply == FavoriteItemDialog.OK) {
	...
	public Object[] getElements(Object inputElement) {
	    List<FavoriteItemVO> result = new ArrayList<FavoriteItemVO>();
