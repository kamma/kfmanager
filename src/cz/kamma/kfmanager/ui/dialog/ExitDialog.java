...
public class ExitDialog extends Dialog {
	...
	buttonYes.addSelectionListener(new org.eclipse.swt.events.SelectionAdapter() {
		...
		result = SWT.YES;
		ConfigHelper.getInstance().setProperty(PreferenceManager.SETTINGS_CONFIRM_ON_EXIT, showNextTime.getSelection() ? "true" : "false");
		sShell.dispose();
	    }
	});
	...
	showNextTime.setSelection(ConfigHelper.getInstance().getPropertyAsBoolean(PreferenceManager.SETTINGS_CONFIRM_ON_EXIT, true));
